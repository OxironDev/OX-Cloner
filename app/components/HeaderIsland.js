    ...
    <header className="header-island">
      <Link href={`/${lang}`} className="logo-link">
        <div className="logo-section">
          ...
          <span className="site-name">OX CLONER</span>
        </div>
      </Link>
      ...
      <div className="header-actions">
        <a href="https://oxirondev.com/support-server" target="_blank" rel="noopener noreferrer" className="discord-link" title="Discord Support">
